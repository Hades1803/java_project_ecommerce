...
public class AddressServiceImpl implements AddressService {
    ...
    public AddressDTO updateAddress(Long addressId, AddressDTO address) {
        // NOTE: This logic appears complex and might have issues. See suggestions below.
        ...
        if (addressFromDB == null) {
            ...
            final Address finalAddress = addressFromDB;
            users.forEach(user -> user.getAddresses().add(finalAddress));
