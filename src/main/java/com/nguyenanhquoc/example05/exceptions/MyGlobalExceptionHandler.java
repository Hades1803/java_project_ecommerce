package com.nguyenanhquoc.example05.exceptions;
...
import com.nguyenanhquoc.example05.payloads.response.APIResponse;
...
public class MyGlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> myConstrainViolationException(ConstraintViolationException e) {
        Map<String, String> res = new HashMap<>();
